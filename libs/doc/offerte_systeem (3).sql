...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 24 jun 2015 om 14:53
-- Serverversie: 5.6.21
-- PHP-versie: 5.6.3
...
--
ALTER TABLE `offertes`
MODIFY `OfferteID` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=115;
--
...
--
ALTER TABLE `werkzaamheden`
MODIFY `WerkzaamheidID` int(7) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=300;
